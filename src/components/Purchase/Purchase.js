        ...
        <div className="container mt-5">
            <div className="row">
                ...
                <div className="form-div mt-5 col-md-6">
                    ...
                    <input  className="form-div-input " {...register("phoneNumber" )} placeholder="Phone Number" required/>
                     <input  className="form-div-input " {...register("address", )} placeholder="Address" required/>
